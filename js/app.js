...
var quizArray = [
  ...
  {text: `<p> THis bird is very elusive and seldom seen</p><p>It's nest is a shallow cup built with marsh vegetation on damp ground under a canopy of dead plants</p><p>eggs are creamy, and spotted with both reddish spots that form a ring at one end</p> <p>Which bird is it hugh?</p> `, answer: 'Yellow rail', yourAnswer: 'Ruby-throated hummingbird',  trueFalse:'', options: ['Yellow rail', 'Ruby-throated hummingbird', 'Ovenbird','Chimney Swift']},
...
function displayStats() {
  if(num === quizArray.length) {
    ...
    `<pre> 
       ...
       For Question: ${currentQuiz.text}
       Your Answer: ${currentQuiz.yourAnswer}
       Correct Answer ${currentQuiz.answer}
       True/Fase: ${currentQuiz.trueFalse}
